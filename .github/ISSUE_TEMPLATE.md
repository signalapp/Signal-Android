...
Before we begin, please note that this tracker is meant for issues only.

If you are looking for support, please see our support center instead:
http://support.whispersystems.org/
or email support@whispersystems.org

If you wish to ask questions or start a discussion, please go to the community forum instead:
