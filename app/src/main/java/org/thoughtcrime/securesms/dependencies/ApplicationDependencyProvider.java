...
import org.thoughtcrime.securesms.crypto.storage.SignalDataStoreImpl;
...
public class ApplicationDependencyProvider implements ApplicationDependencies.Provider {
  ...
  @NonNull
  @Override
  public SignalServiceMessageSender provideSignalServiceMessageSender(@NonNull SignalWebSocket signalWebSocket) {
      return new SignalServiceMessageSender(provideSignalServiceNetworkAccess().getConfiguration(context),
                                            new DynamicCredentialsProvider(context),
                                            new SignalDataStoreImpl(context),
