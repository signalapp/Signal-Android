...
public class InCallActivity extends Activity {
  ...
  public static final String ANSWER_ACTION = InCallActivity.class.getCanonicalName() + ".ANSWER_ACTION";
  public static final String DENY_ACTION = InCallActivity.class.getCanonicalName() + ".DENY_ACTION";
  public static final String END_CALL_ACTION = InCallActivity.class.getCanonicalName() + ".END_CALL_ACTION";

//    public static final String EXTRA_ENABLE_VIDEO_IF_AVAILABLE = InCallActivity.class.getCanonicalName() + ".ENABLE_VIDEO_IF_AVAILABLE";
...
//    private boolean enableVideoIfAvailable;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.sim_incall_screen);
...
//        getIntent().removeExtra(EXTRA_ENABLE_VIDEO_IF_AVAILABLE);
  ...
  private void initData() {
    mData = Arrays.asList(getResources().getStringArray(R.array.sim_dial_options));
  }

  private void initView() {
    mRecyclerView = findViewById(R.id.sim_incall_options);
    LinearLayoutManager layoutManager = new LinearLayoutManager(this);
    layoutManager.setOrientation(RecyclerView.VERTICAL);
    mRecyclerView.setLayoutManager(layoutManager);

    mAdapter = new InCallAdapter(this, new View.OnClickListener() {
      @Override
...
//            callScreen.setActiveCall(event.getRecipient(), getString(R.string.RedPhone_ending_call), event.getLocalRenderer());
  ...
  private void handleEndCall() {
    ...
    Intent intent = new Intent(InCallActivity.this, WebRtcCallService.class);
...
//        callScreen.setActiveCall(event.getRecipient(), getString(R.string.RedPhone_dialing), event.getLocalRenderer());
  ...
  private void handleTerminate(@NonNull Recipient recipient, @NonNull SurfaceViewRenderer localRenderer */
/*, int terminationType *//*
) {
  ...
  private void handleNoSuchUser(final @NonNull WebRtcViewModel event) {
    ...
    dialog.setPositiveButton(R.string.RedPhone_got_it, new OnClickListener() {
      ...
      public void onClick(DialogInterface dialog, int which) {
        InCallActivity.this.handleTerminate(event.getRecipient(), event.getLocalRenderer());
      }
    });
...
//                    TextSecureIdentityKeyStore identityKeyStore = new TextSecureIdentityKeyStore(InCallActivity.this);
  ...
  public void onEventMainThread(final WebRtcViewModel event) {
    ...
    switch (event.getState()) {
      ...
      case CALL_DISCONNECTED:
        handleTerminate(event.getRecipient(), event.getLocalRenderer());
        break;
      case NO_SUCH_USER:
...
//        }
  ...
  private class AudioMuteButtonListener implements WebRtcCallControls.MuteButtonListener {
    ...
    public void onToggle(boolean isMuted) {
      InCallActivity.this.handleSetMuteAudio(isMuted);
    }
  }
  ...
  private class VideoMuteButtonListener implements WebRtcCallControls.MuteButtonListener {
    @Override
    public void onToggle(boolean isMuted) {
      InCallActivity.this.handleSetMuteVideo(isMuted);
    }
  }
  ...
  private class CameraFlipButtonListener implements WebRtcCallControls.CameraFlipButtonListener {
    ...
    public void onToggle() {
      InCallActivity.this.handleFlipCamera();
    }
  }
  ...
  private class SpeakerButtonListener implements WebRtcCallControls.SpeakerButtonListener {
    ...
    public void onSpeakerChange(boolean isSpeaker) {
      AudioManager audioManager = ServiceUtil.getAudioManager(InCallActivity.this);
  ...
  private class IncomingCallActionListener implements WebRtcAnswerDeclineButton.AnswerDeclineListener {
    ...
    public void onAnswered() {
      InCallActivity.this.handleAnswerCall();
    }

    @Override
    public void onDeclined() {
      InCallActivity.this.handleDenyCall();
    }
  }
