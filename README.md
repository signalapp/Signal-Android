...
We use GitHub for bug tracking. Please search [the existing issues](https://github.com/signalapp/Signal-Android/issues) for your bug and create a new one if the issue is not yet tracked!
...
Interested in helping to translate Signal? Contribute [here](https://www.transifex.com/projects/p/signal-android/)
