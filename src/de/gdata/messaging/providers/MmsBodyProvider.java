...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://de.gdata.provider.securesms.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("de.gdata.provider.securesms.mms", "mms/#", SINGLE_ROW);
  }
