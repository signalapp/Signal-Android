...
public class TextSecurePreferences {
  ...
  public  static final String WALLPAPER_PREF                   = "pref_wallpaper";
  ...
  public static boolean removeBackgroudColor(Context context) {
    return PreferenceManager.getDefaultSharedPreferences(context).edit().remove(BACKGROUND_COLOR_PREF).commit();
  }
