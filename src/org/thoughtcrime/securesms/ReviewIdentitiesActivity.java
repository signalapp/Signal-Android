...
public class ReviewIdentitiesActivity extends SherlockListActivity {
  ...
  private void deleteIdentity(String name, String keyString) {
    ...
    alertDialog.setTitle(R.string.delete_identity_dialogtitle);
    alertDialog.setMessage(R.string.delete_identity_are_you_sure_you_want_to_delete_this_identity_key);
  ...
  private class IdentitiesListAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
      ...
      if (!valid)
        identityName = getString(R.string.invalid_identity);
