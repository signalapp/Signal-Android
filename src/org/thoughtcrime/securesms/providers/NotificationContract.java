...
public class NotificationContract {
  ...
  public static class ContactNotifications implements ContactNotificationsColumns, BaseColumns {
    public static final String CONTENT_AUTHORITY =
        "org.thoughtcrime.notificationprovider.securesms";
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    public static final String PATH_CONTACTS = "contacts";
    public static final String PATH_CONTACTS_LOOKUP = "contactslookup";

    public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_CONTACTS)
        .build();
    public static final Uri CONTENT_LOOKUP_URI = BASE_CONTENT_URI.buildUpon()
        .appendPath(PATH_CONTACTS_LOOKUP).build();

    public static final String[] PROJECTION_SUMMARY = new String[] { _ID, CONTACT_NAME, SUMMARY };
    ...
    public static Uri buildLookupUri(String lookupKey, String contactId) {
      ...
      return CONTENT_LOOKUP_URI.buildUpon().appendPath(lookupKey).appendPath(contactId).build();
    }
