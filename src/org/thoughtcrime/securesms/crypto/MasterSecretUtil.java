...
public class MasterSecretUtil {
  ...
  {
    try {
      byte[] encryptedAndMacdMasterSecret = getEncryptedAndMacdMasterSecret(context);
  ...
  public static byte[] getEncryptedAndMacdMasterSecret(Context context) throws IOException {
