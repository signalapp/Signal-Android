...
public class ConfigContactsActivity extends FragmentActivity {
  ...
  private static final String[] CONTACT_PROJECTION = new String[] { Contacts._ID,
  ...
  /**
   * Get intent that starts the notification config for a contact. rowId is the notifications table
   * row of the contact to pass through.
   * 
  ...
  private static Intent getConfigPerContactIntent(Context context, long rowId) {
    ...
    i.putExtra(ConfigNotificationActivity.EXTRA_CONTACT_URI,
  ...
  public static class ConfigContactsListFragment extends ListFragment implements
    ...
    public boolean onContextItemSelected(MenuItem item) {
      ...
      if (info.id != -1) {
        ...
        case CONTEXT_MENU_DELETE_ID:
          getActivity().getContentResolver().delete(ContactNotifications.buildContactUri(info.id),
              null, null);
          return true;
        default:
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
      ...
      contactsAutoComplete.setOnItemClickListener(new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
          ...
          startActivity(getConfigPerContactIntent(
              getActivity(),
              ContactNotifications.buildLookupUri(c.getString(COLUMN_LOOKUP_KEY),
                  c.getString(COLUMN_CONTACT_ID))));
      ...
      mContactNotificationsAdapter =
          new SimpleCursorAdapter(getActivity(), R.layout.simple_list_item_2, null, from, to, 0);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
      ...
      case LOADER_SYSTEM_CONTACTS:
        return new CursorLoader(getActivity(), Contacts.CONTENT_URI, CONTACT_PROJECTION, null,
            null, null);
      }
      return null;
    }
