...
public abstract class DisplayRecord {
    ...
    private int KEY_LENGTH = 147; //Length of the key within the body
    ...
    public boolean displaysAKey() {
        return (getDisplayBody().length() == KEY_LENGTH && !((getDisplayBody() + "").contains(" ")));
    }
