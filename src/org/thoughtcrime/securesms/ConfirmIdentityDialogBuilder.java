...
public class ConfirmIdentityDialogBuilder extends MaterialDialog.Builder {

  private static final String TAG = ConfirmIdentityDialogBuilder.class.getSimpleName();

  private DialogInterface.OnClickListener callback;

  public ConfirmIdentityDialogBuilder(Context context,
                                      ...
                                      IdentityKeyMismatch mismatch)
  {
    ...
    positiveText(R.string.ConfirmIdentityDialog_accept);
    negativeText(android.R.string.cancel);
    callback(new ButtonCallback(masterSecret, messageRecord, mismatch));
  }
  ...
  private class ButtonCallback extends MaterialDialog.ButtonCallback {
    ...
    private ButtonCallback(MasterSecret masterSecret, MessageRecord messageRecord, IdentityKeyMismatch mismatch) {
