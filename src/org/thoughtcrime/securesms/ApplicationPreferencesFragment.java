    ...
    implements SharedPreferences.OnSharedPreferenceChangeListener
{
  ...
  public void onCreate(Bundle icicle) {
    dynamicTheme.onCreate(this.getActivity());
    dynamicLanguage.onCreate(this.getActivity());
  ...
  public void onResume() {
    super.onResume();
    dynamicTheme.onResume(this.getActivity());
    dynamicLanguage.onResume(this.getActivity());
  ...
  public void onActivityResult(int reqCode, int resultCode, Intent data) {
    ...
    Log.w("ApplicationPreferencesFragment", "Got result: " + resultCode + " for req: " + reqCode);

    if (resultCode == Activity.RESULT_OK) {
      switch (reqCode) {
      case PICK_IDENTITY_CONTACT:      handleIdentitySelection(data); break;
      case ENABLE_PASSPHRASE_ACTIVITY: this.getActivity().finish();   break;
      }
    }
  }
  ...
  private void initializePlatformSpecificOptions() {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT && pushSmsCategory != null) {
      ...
      if (Util.isDefaultSmsProvider(this.getActivity())) {
        ...
        intent.putExtra(Telephony.Sms.Intents.EXTRA_PACKAGE_NAME, this.getActivity().getPackageName());
  ...
  private void initializePushMessagingToggle() {
    ...
    preference.setChecked(TextSecurePreferences.isPushRegistered(this.getActivity()));
    preference.setOnPreferenceChangeListener(new PushMessagingClickListener());
  }

  private void initializeIdentitySelection() {
    ContactIdentityManager identity = ContactIdentityManager.getInstance(this.getActivity());
    ...
    if (identity.isSelfIdentityAutoDetected()) {
      ...
      if (contactUri != null) {
        String contactName = ContactAccessor.getInstance().getNameFromContact(this.getActivity(), contactUri);
  ...
  private void handleIdentitySelection(Intent data) {
    ...
    if (contactUri != null) {
      TextSecurePreferences.setIdentityContactUri(this.getActivity(), contactUri.toString());
      initializeIdentitySelection();
    }
  }
  ...
  private class PushMessagingClickListener implements Preference.OnPreferenceChangeListener {
    ...
    private class DisablePushMessagesTask extends AsyncTask<Void, Void, Integer> {
      ...
      protected void onPreExecute() {
        dialog = ProgressDialog.show(ApplicationPreferencesFragment.this.getActivity(),
      ...
      protected void onPostExecute(Integer result) {
        ...
        switch (result) {
          case NETWORK_ERROR:
            Toast.makeText(ApplicationPreferencesFragment.this.getActivity(),
                           getString(R.string.ApplicationPreferencesActivity_error_connecting_to_server),
                           Toast.LENGTH_LONG).show();
            break;
          case SUCCESS:
            ((CheckBoxPreference)preference).setChecked(false);
            TextSecurePreferences.setPushRegistered(ApplicationPreferencesFragment.this.getActivity(), false);
            break;
        }
      }
      ...
      protected Integer doInBackground(Void... params) {
        try {
          Context           context = ApplicationPreferencesFragment.this.getActivity();
          ...
          Log.w("ApplicationPreferencesFragment", afe);
          return SUCCESS;
        } catch (IOException ioe) {
          Log.w("ApplicationPreferencesFragment", ioe);
    ...
    public boolean onPreferenceChange(final Preference preference, Object newValue) {
      if (((CheckBoxPreference)preference).isChecked()) {
        AlertDialog.Builder builder = new AlertDialog.Builder(ApplicationPreferencesFragment.this.getActivity());
        builder.setIcon(Dialogs.resolveIcon(ApplicationPreferencesFragment.this.getActivity(), R.attr.dialog_info_icon));
        ...
        Intent intent = new Intent(ApplicationPreferencesFragment.this.getActivity(), RegistrationActivity.class);
        intent.putExtra("master_secret", ApplicationPreferencesFragment.this.getActivity().getIntent().getParcelableExtra("master_secret"));
  ...
  private class ChangePassphraseClickListener implements Preference.OnPreferenceClickListener {
    @Override
    public boolean onPreferenceClick(Preference preference) {
       if (MasterSecretUtil.isPassphraseInitialized(ApplicationPreferencesFragment.this.getActivity())) {
        startActivity(new Intent(ApplicationPreferencesFragment.this.getActivity(), PassphraseChangeActivity.class));
      } else {
        Toast.makeText(ApplicationPreferencesFragment.this.getActivity(),
  ...
  private class TrimNowClickListener implements Preference.OnPreferenceClickListener {
    @Override
    public boolean onPreferenceClick(Preference preference) {
      final int threadLengthLimit = TextSecurePreferences.getThreadTrimLength(ApplicationPreferencesFragment.this.getActivity());
      AlertDialog.Builder builder = new AlertDialog.Builder(ApplicationPreferencesFragment.this.getActivity());
      ...
      builder.setPositiveButton(R.string.ApplicationPreferencesActivity_delete,
        ...
        @Override
        public void onClick(DialogInterface dialog, int which) {
          Trimmer.trimAllThreads(ApplicationPreferencesFragment.this.getActivity(), threadLengthLimit);
        }
      });
  ...
  private class DisablePassphraseClickListener implements Preference.OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(final Preference preference, Object newValue) {
      if (!((CheckBoxPreference)preference).isChecked()) {
        ...
        builder.setIcon(Dialogs.resolveIcon(ApplicationPreferencesFragment.this.getActivity(), R.attr.dialog_alert_icon));
        builder.setPositiveButton(R.string.ApplicationPreferencesActivity_disable, new DialogInterface.OnClickListener() {
          ...
          public void onClick(DialogInterface dialog, int which) {
            ...
            MasterSecretUtil.changeMasterSecretPassphrase(ApplicationPreferencesFragment.this.getActivity(),
                                                          masterSecret,
                                                          MasterSecretUtil.UNENCRYPTED_PASSPHRASE);


            TextSecurePreferences.setPasswordDisabled(ApplicationPreferencesFragment.this.getActivity(), true);
            ((CheckBoxPreference)preference).setChecked(true);

            Intent intent = new Intent(ApplicationPreferencesFragment.this.getActivity(), KeyCachingService.class);
            intent.setAction(KeyCachingService.DISABLE_ACTION);
            ApplicationPreferencesFragment.this.getActivity().startService(intent);
          }
        });
        builder.setNegativeButton(android.R.string.cancel, null);
        builder.show();
      } else {
        Intent intent = new Intent(ApplicationPreferencesFragment.this.getActivity(),
  ...
  private class TrimLengthValidationListener implements Preference.OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
      ...
      try {
        ...
        Log.w("ApplicationPreferencesFragment", nfe);
        return false;
      }
  ...
  private class ApnPreferencesClickListener implements Preference.OnPreferenceClickListener {
    ...
    @Override
    public boolean onPreferenceClick(Preference preference) {
      startActivity(new Intent(ApplicationPreferencesFragment.this.getActivity(), MmsPreferencesActivity.class));
      return true;
    }
  }
  ...
  private class RingtoneSummaryListener implements Preference.OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
      ...
      if (TextUtils.isEmpty(value)) {
        ...
        Ringtone tone = RingtoneManager.getRingtone(ApplicationPreferencesFragment.this.getActivity(),
          Uri.parse(value));
        if (tone != null) {
          preference.setSummary(tone.getTitle(ApplicationPreferencesFragment.this.getActivity()));
        }
      }
  ...
  private class SubmitDebugLogListener implements Preference.OnPreferenceClickListener {
    @Override
    public boolean onPreferenceClick(Preference preference) {
      final Intent intent = new Intent(ApplicationPreferencesFragment.this.getActivity(), LogSubmitActivity.class);
      startActivity(intent);
      return true;
    }
  }
  ...
  private String buildOutgoingSmsDescription() {
    ...
    final boolean       dataFallback    = TextSecurePreferences.isFallbackSmsAllowed(this.getActivity());
    final boolean       dataFallbackAsk = TextSecurePreferences.isFallbackSmsAskRequired(this.getActivity());
    final boolean       nonData         = TextSecurePreferences.isDirectSmsAllowed(this.getActivity());
